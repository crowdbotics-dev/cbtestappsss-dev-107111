"""
Django settings for cbtestappsss_dev_107111 project.
...
ROOT_URLCONF = 'cbtestappsss_dev_107111.urls'
...
WSGI_APPLICATION = 'cbtestappsss_dev_107111.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cbtestappsss_dev_107111 API",
    "DESCRIPTION": "API documentation for cbtestappsss_dev_107111 App",
    "VERSION": "v1",
}
